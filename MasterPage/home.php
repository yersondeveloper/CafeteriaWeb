<?php
session_start();
//require_once '../limite_session.php';
        ...
        <header>
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                <div class="container-fluid">
                    <a class="navbar-brand" href="#">Cafeteria V1.0</a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="home.php?mod=ventas">
                                <i class="fas fa-money-bill-alt"></i>  
                                Ventas</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="home.php?mod=productos">
                ...
                <div class="col-12 col-xs-12 col-sm-12 col-md-12">
                    <div class="row">
                        ...
                        switch (@$_GET['mod']) {
                            ...
                            case "ventas":
                                require_once("../modulos/ventas.php");
                                break;
                            case "productos":
                                require_once("../modulos/productos.php");
                                break;
                            case "usuarios":
